...
model_full_sb_20mm_0 <- brm(sb_age0_catch ~ volume_c + year_fac*review_region + (1|station_fac) + (1|id),
           family = poisson, data = dat_20mm_sb_age0,
...
save(model_full_sb_20mm_0, file = 'sb_model_age_0_full_5e3.Rds')  # save model
